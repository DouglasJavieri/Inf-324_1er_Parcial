...
<body>
    <div class="container mt-5 my-5">
        ...
        <a class="btn btn-secondary w-100 my-2" href="listarImpuesto.php">Listar Personas por Tipo de Impuesto</a>
        <a class="btn btn-warning w-100 my-2" href="listar.php">Listar Personas por Tipo de Impuesto</a>
